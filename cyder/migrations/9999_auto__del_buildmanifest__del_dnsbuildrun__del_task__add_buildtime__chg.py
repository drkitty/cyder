...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BuildTime'
        db.create_table('buildtime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('cyder', ['BuildTime'])


        # Changing field 'MX.ttl'
        db.alter_column('mx', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'PTR.ttl'
        db.alter_column('ptr', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'TXT.ttl'
        db.alter_column('txt', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SRV.ttl'
        db.alter_column('srv', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SOA.ttl'
        db.alter_column('soa', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'AddressRecord.ttl'
        db.alter_column('address_record', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Nameserver.ttl'
        db.alter_column('nameserver', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'SSHFP.ttl'
        db.alter_column('sshfp', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'StaticInterface.ttl'
        db.alter_column('static_interface', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Deleting field 'Domain.dirty'
        db.delete_column('domain', 'dirty')


        # Changing field 'CNAME.ttl'
        db.alter_column('cname', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BuildTime'
        db.delete_table('buildtime')


        # Changing field 'MX.ttl'
        db.alter_column('mx', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'PTR.ttl'
        db.alter_column('ptr', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'TXT.ttl'
        db.alter_column('txt', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SRV.ttl'
        db.alter_column('srv', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SOA.ttl'
        db.alter_column('soa', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'AddressRecord.ttl'
        db.alter_column('address_record', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Nameserver.ttl'
        db.alter_column('nameserver', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SSHFP.ttl'
        db.alter_column('sshfp', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'StaticInterface.ttl'
        db.alter_column('static_interface', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
        # Adding field 'Domain.dirty'
        db.add_column('domain', 'dirty',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CNAME.ttl'
        db.alter_column('cname', 'ttl', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'cyder.addressrecord': {
            ...
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600'}),
        ...
        'cyder.buildtime': {
            'Meta': {'object_name': 'BuildTime', 'db_table': "'buildtime'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cyder.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600'})
        },
        'cyder.soaav': {
