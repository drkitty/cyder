...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('attribute', (
            ...
            ('attribute_type', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=1, charset='ascii')),
            ('value_type', self.gf('cyder.base.eav.fields.AttributeValueTypeField')(collation='ascii_bin', max_length=20, attribute_type_field='', charset='ascii')),
        ))
        ...
        db.create_table('domain', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=255, unique=True, charset='ascii')),
        ...
        db.create_table('workgroup', (
            ...
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=100, unique=True, charset='ascii')),
        ))
        ...
        db.create_table('cname', (
            ...
            ('label', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=63, charset='ascii', blank=True)),
            ('fqdn', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=255, charset='ascii', db_index=True, blank=True)),
            ('ttl', self.gf('django.db.models.fields.PositiveIntegerField')(default=3600, null=True, blank=True)),
            ('description', self.gf('cyder.base.fields.CharField')(collation='utf8mb4_general_ci', max_length=1000, charset='utf8mb4', blank=True)),
            ('ctnr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=100, charset='ascii')),
        ))
        ...
        db.create_table('ptr', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('ip_str', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=39, charset='ascii')),
            ...
            ('ip_type', self.gf('cyder.base.fields.CharField')(default='4', max_length=1, charset='ascii', collation='ascii_general_ci')),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('static_interface', (
            ...
            ('ip_type', self.gf('cyder.base.fields.CharField')(default='4', max_length=1, charset='ascii', collation='ascii_general_ci')),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mac', self.gf('cyder.base.fields.MacAddrField')(collation='ascii_general_ci', max_length=17, null=True, charset='ascii', dhcp_enabled='dhcp_enabled')),
        ...
        db.create_table('network', (
            ...
            ('ip_type', self.gf('cyder.base.fields.CharField')(default='4', max_length=1, charset='ascii', collation='ascii_bin')),
            ...
            ('network_str', self.gf('cyder.base.fields.CharField')(collation='ascii_bin', max_length=49, charset='ascii')),
            ('prefixlen', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('dhcpd_raw_include', self.gf('cyder.base.fields.TextField')(collation='ascii_bin', charset='ascii', blank=True)),
        ))
        ...
        db.create_table('range', (
            ...
            ('range_type', self.gf('cyder.base.fields.CharField')(default='st', max_length=2, charset='ascii', collation='ascii_bin')),
            ('ip_type', self.gf('cyder.base.fields.CharField')(default='4', max_length=1, charset='ascii', collation='ascii_bin')),
            ...
            ('start_str', self.gf('cyder.base.fields.CharField')(collation='ascii_bin', max_length=39, charset='ascii')),
            ...
            ('end_str', self.gf('cyder.base.fields.CharField')(collation='ascii_bin', max_length=39, charset='ascii')),
            ...
            ('allow', self.gf('cyder.base.fields.CharField')(default='l', max_length=1, charset='ascii', collation='ascii_bin')),
            ('dhcpd_raw_include', self.gf('cyder.base.fields.TextField')(collation='ascii_bin', charset='ascii', blank=True)),
            ('dhcp_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('name', self.gf('cyder.base.fields.CharField')(collation='utf8mb4_general_ci', max_length=50, charset='utf8mb4', blank=True)),
            ('description', self.gf('cyder.base.fields.TextField')(collation='utf8mb4_general_ci', charset='utf8mb4', blank=True)),
        ...
        db.create_table('ctnr', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=100, unique=True, charset='ascii')),
            ('description', self.gf('cyder.base.fields.CharField')(collation='utf8mb4_general_ci', max_length=200, charset='utf8mb4', blank=True)),
            ('email_contact', self.gf('cyder.base.fields.CharField')(collation='utf8mb4_general_ci', max_length=75, charset='utf8mb4', blank=True)),
        ))
        ...
        db.create_table(u'task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=255, charset='ascii')),
            ('ttype', self.gf('cyder.base.fields.CharField')(collation='ascii_bin', max_length=255, charset='ascii')),
        ))
        ...
        db.create_table('mx', (
            ...
            ('ctnr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=100, charset='ascii')),
        ...
        db.create_table('nameserver', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Domain'])),
            ('server', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=255, charset='ascii')),
        ...
        db.create_table('srv', (
            ...
            ('label', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=63, charset='ascii', blank=True)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Domain'])),
            ('fqdn', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=255, charset='ascii', blank=True)),
            ('target', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=100, charset='ascii', blank=True)),
        ...
        db.create_table('sshfp', (
            ...
            ('ctnr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('cyder.base.fields.CharField')(collation='ascii_general_ci', max_length=256, charset='ascii')),
        ...
        db.create_table('txt', (
            ...
            ('ctnr', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyder.Ctnr'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('txt_data', self.gf('cyder.base.fields.TextField')(collation='ascii_general_ci', charset='ascii')),
        ))
    ...
    models = {
        ...
        'cyder.addressrecord': {
            ...
            'description': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '1000', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Domain']"}),
            'fqdn': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'", 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_lower': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ip_str': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '39', 'charset': "'ascii'"}),
            'ip_type': ('cyder.base.fields.CharField', [], {'default': "'4'", 'max_length': '1', 'charset': "'ascii'", 'collation': "'ascii_general_ci'"}),
            'ip_upper': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'label': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '63', 'charset': "'ascii'", 'blank': 'True'}),
        ...
        'cyder.attribute': {
            ...
            'attribute_type': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '1', 'charset': "'ascii'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'"}),
            'value_type': ('cyder.base.eav.fields.AttributeValueTypeField', [], {'collation': "'ascii_bin'", 'max_length': '20', 'attribute_type_field': "''", 'charset': "'ascii'"})
        },
        'cyder.buildmanifest': {
        ...
        'cyder.cname': {
            ...
            'label': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '63', 'charset': "'ascii'", 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'target': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'charset': "'ascii'"}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'cyder.ctnr': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '200', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'domains': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.Domain']", 'symmetrical': 'False', 'blank': 'True'}),
            'email_contact': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '75', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'unique': 'True', 'charset': "'ascii'"}),
        ...
        'cyder.domain': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'unique': 'True', 'charset': "'ascii'"}),
        ...
        'cyder.dynamicinterface': {
            ...
            'mac': ('cyder.base.fields.MacAddrField', [], {'collation': "'ascii_general_ci'", 'max_length': '17', 'null': 'True', 'charset': "'ascii'", 'dhcp_enabled': "'dhcp_enabled'"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'cyder.mx': {
            ...
            'server': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'charset': "'ascii'"}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'cyder.nameserver': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'server': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'"}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'cyder.network': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dhcpd_raw_include': ('cyder.base.fields.TextField', [], {'collation': "'ascii_bin'", 'charset': "'ascii'", 'blank': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_lower': ('django.db.models.fields.BigIntegerField', [], {'blank': 'True'}),
            'ip_type': ('cyder.base.fields.CharField', [], {'default': "'4'", 'max_length': '1', 'charset': "'ascii'", 'collation': "'ascii_bin'"}),
            'ip_upper': ('django.db.models.fields.BigIntegerField', [], {'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'network_str': ('cyder.base.fields.CharField', [], {'collation': "'ascii_bin'", 'max_length': '49', 'charset': "'ascii'"}),
        ...
        'cyder.range': {
            ...
            'allow': ('cyder.base.fields.CharField', [], {'default': "'l'", 'max_length': '1', 'charset': "'ascii'", 'collation': "'ascii_bin'"}),
            'allow_voip_phones': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('cyder.base.fields.TextField', [], {'collation': "'utf8mb4_general_ci'", 'charset': "'utf8mb4'", 'blank': 'True'}),
            'dhcp_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'dhcpd_raw_include': ('cyder.base.fields.TextField', [], {'collation': "'ascii_bin'", 'charset': "'ascii'", 'blank': 'True'}),
            ...
            'end_str': ('cyder.base.fields.CharField', [], {'collation': "'ascii_bin'", 'max_length': '39', 'charset': "'ascii'"}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'name': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '50', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'network': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Network']"}),
            'range_type': ('cyder.base.fields.CharField', [], {'default': "'st'", 'max_length': '2', 'charset': "'ascii'", 'collation': "'ascii_bin'"}),
            ...
            'start_str': ('cyder.base.fields.CharField', [], {'collation': "'ascii_bin'", 'max_length': '39', 'charset': "'ascii'"}),
        ...
        'cyder.soa': {
            ...
            'contact': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'charset': "'ascii'"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '200', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'dirty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'primary': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'charset': "'ascii'"}),
        ...
        'cyder.srv': {
            ...
            'description': ('cyder.base.fields.CharField', [], {'collation': "'utf8mb4_general_ci'", 'max_length': '1000', 'charset': "'utf8mb4'", 'blank': 'True'}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cyder.Domain']"}),
            'fqdn': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '63', 'charset': "'ascii'", 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'port': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'target': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '100', 'charset': "'ascii'", 'blank': 'True'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'cyder.sshfp': {
            ...
            'fqdn': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'", 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '256', 'charset': "'ascii'"}),
            'label': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '63', 'charset': "'ascii'", 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'})
        ...
        'cyder.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'task': ('cyder.base.fields.CharField', [], {'collation': "'ascii_general_ci'", 'max_length': '255', 'charset': "'ascii'"}),
            'ttype': ('cyder.base.fields.CharField', [], {'collation': "'ascii_bin'", 'max_length': '255', 'charset': "'ascii'"})
        },
        'cyder.token': {
        ...
        'cyder.txt': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'}),
            'txt_data': ('cyder.base.fields.TextField', [], {'collation': "'ascii_general_ci'", 'charset': "'ascii'"}),
            'views': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cyder.View']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'cyder.userprofile': {
